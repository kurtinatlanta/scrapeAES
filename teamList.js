let masterTeamList = {
  'A5 18 Bob': { playing: false, rank: 1 },
  'A5 18 John': { playing: false, rank: 2 },
  'A5 18 Tee': { playing: false, rank: 3 },
  'A5 17 Jing': { playing: false, rank: 4 },
  'A5 17 Marc': { playing: false, rank: 5 },
  'A5 17 Lisa': { playing: false, rank: 6 },
  'A5 16 Gabe': { playing: false, rank: 7 },
  'A5 16 Scott': { playing: false, rank: 8 },
  'A5 16 Liang': { playing: false, rank: 9 },
  'A5 15 Boba': { playing: false, rank: 10 },
  'A5 15 JJ': { playing: false, rank: 11 },
  'A5 15 LA': { playing: false, rank: 12 },
  'A5 15 Sydney': { playing: false, rank: 13 },
  'A5 14 Suzanne': { playing: false, rank: 14 },
  'A5 14 Karen': { playing: true, rank: 15 },
  'A5 14 Allison': { playing: false, rank: 16 },
  'A5 14 Alex': { playing: false, rank: 17 },
  'A5 14 Brianna': { playing: false, rank: 18 },
  'A5 13 Earl': { playing: false, rank: 19 },
  'A5 13 Anna Marie': { playing: false, rank: 20 },
  'A5 13 Betty': { playing: false, rank: 21 },
  'A5 13 Tina': { playing: false, rank: 22 },
  'A5 13 Jordan': { playing: false, rank: 23 },
  'A5 12 Jing': { playing: false, rank: 24 },
  'A5 12 Jake': { playing: false, rank: 25 },
  'A5 12 Liz': { playing: false, rank: 26 },
  'A5 12 Mercedes': { playing: true, rank: 27 },
  'A5 12 Jordan': { playing: true, rank: 28 },
  'A5 12 Donna': { playing: true, rank: 29 },
  'A5 11 Walter': { playing: false, rank: 30 },
  ...
  // Boys
  'A5 18 Boys': { playing: false, rank: 36 },
  'A5 18 Amber': { playing: false, rank: 36 },
  'A5 16 Boys': { playing: false, rank: 37 },
  'A5 16 Kip': { playing: false, rank: 37 },
  'A5 14 Boys': { playing: false, rank: 39 },
  'A5 14 Lori': { playing: false, rank: 38 }
};
