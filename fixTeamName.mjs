export default function fixTeamName(teamName) {
  ...
  newName = newName.replace('  (GA)', '');
  newName = newName.replace(' (GA)', '');
  newName = newName.replace(' (TN)', '');
  newName = newName.replace('A5Chatt ', 'A5 Chattanooga ');
  ...
  newName = newName.replace('A5 Mizuno Boys 14-1', 'A5 14 Kip');
  newName = newName.replace('A5 Mizuno Boys 14-2', 'A5 14 Rachel');
  newName = newName.replace('A5 Mizuno Boys 16-1', 'A5 16 Carlos');
  newName = newName.replace('A5 Mizuno Boys 18-1', 'A5 18 T-Nol');
  ...
  newName = newName.replace('15-', '15 ');
  newName = newName.replace('16-', '16 ');
  newName = newName.replace('17-', '17 ');
